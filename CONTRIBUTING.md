...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/AzUnzipEverything.git

Push to your fork and [submit a pull request](https://github.com/fboucher/AzUnzipEverything/compare/) against the `dev` branch.
